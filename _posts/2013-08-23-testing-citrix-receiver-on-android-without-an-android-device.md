...
[<img class="alignnone size-full wp-image-3466" alt="Parallels-AndroidVM" src="https://stealthpuppy.com/media/2013/08/Parallels-AndroidVM.png]({{site.baseurl}}/media/2013/08/Parallels-AndroidVM.png)
...
[<img class="alignnone size-full wp-image-3475" alt="GenymotionDownloadOptions" src="https://stealthpuppy.com/media/2013/08/GenymotionDownloadOptions.png]({{site.baseurl}}/media/2013/08/GenymotionDownloadOptions.png)
...
[<img class="alignnone size-full wp-image-3470" alt="AvailableVMs" src="https://stealthpuppy.com/media/2013/08/AvailableVMs.png]({{site.baseurl}}/media/2013/08/AvailableVMs.png)
...
[<img class="alignnone size-full wp-image-3467" alt="AndroidLockScreen" src="https://stealthpuppy.com/media/2013/08/AndroidLockScreen.png]({{site.baseurl}}/media/2013/08/AndroidLockScreen.png)

Once the up and running, I've set it up with my Google credentials and downloaded Google Chrome and Citrix Receiver:

[<img class="alignnone size-full wp-image-3468" alt="AndroidHome" src="https://stealthpuppy.com/media/2013/08/AndroidHome.png]({{site.baseurl}}/media/2013/08/AndroidHome.png)

Receiver works just like you'd expect:

[<img class="alignnone size-full wp-image-3469" alt="AndroidReceiverWord" src="https://stealthpuppy.com/media/2013/08/AndroidReceiverWord.png]({{site.baseurl}}/media/2013/08/AndroidReceiverWord.png)
