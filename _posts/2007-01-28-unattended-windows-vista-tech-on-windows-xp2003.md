...
tags:
  ...
  - Windows-Vista
---
**UPDATE** (09/12/2007): Updated with the list of applications and components listed here: [Windows Vista components available for Windows XP]({{site.baseurl}}/windows-vista-components-available-for-windows-xp).
