...
[Files necessary to run the Office Customization Tool were not found. Run Setup from the installation point of a qualifying product]({{site.baseurl}}/media/2010/05/Office12.png)
...
[Office installation source without the Admin folder]({{site.baseurl}}/media/2010/05/OfficeInstallFolder.png)
...
![Office 2010 install location]({{site.baseurl}}/media/2010/05/Office04.png)
...
![Office 2010 customise licensing and setup user interface]({{site.baseurl}}/media/2010/05/Office05.png)
