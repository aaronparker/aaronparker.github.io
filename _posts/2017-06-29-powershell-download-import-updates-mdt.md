...
<figure id="attachment_5468" aria-describedby="caption-attachment-5468" style="width: 1024px" class="wp-caption alignnone">[<img class="size-large wp-image-5468" src="https://stealthpuppy.com/media/2017/06/Import-1024x638.png" alt="Downloading and importing updates into MDT via PowerShell" width="1024" height="638" srcset="https://stealthpuppy.com/media/2017/06/Import-1024x638.png 1024w, https://stealthpuppy.com/media/2017/06/Import-150x93.png 150w, https://stealthpuppy.com/media/2017/06/Import-300x187.png 300w, https://stealthpuppy.com/media/2017/06/Import-768x479.png 768w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2017/06/Import.png)<figcaption id="caption-attachment-5468" class="wp-caption-text">Downloading and importing updates into MDT via PowerShell*
...
<figure id="attachment_5470" aria-describedby="caption-attachment-5470" style="width: 1024px" class="wp-caption alignnone">[<img class="size-large wp-image-5470" src="https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloading-1024x458.png" alt="Get-LatestUpdates.ps1 - downloading updates" width="1024" height="458" srcset="https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloading-1024x458.png 1024w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloading-150x67.png 150w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloading-300x134.png 300w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloading-768x343.png 768w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloading.png 1264w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloading.png)<figcaption id="caption-attachment-5470" class="wp-caption-text">Get-LatestUpdates.ps1 - downloading updates*
...
<figure id="attachment_5471" aria-describedby="caption-attachment-5471" style="width: 1024px" class="wp-caption alignnone">[<img class="size-large wp-image-5471" src="https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloaded-1024x458.png" alt="Get-LatestUpdates.ps1 - latest update downloaded" width="1024" height="458" srcset="https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloaded-1024x458.png 1024w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloaded-150x67.png 150w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloaded-300x134.png 300w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloaded-768x343.png 768w, https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloaded.png 1264w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2017/06/Get-LatestUpdates-Downloaded.png)<figcaption id="caption-attachment-5471" class="wp-caption-text">Get-LatestUpdate.ps1 - latest update downloaded*
...
<figure id="attachment_5472" aria-describedby="caption-attachment-5472" style="width: 1024px" class="wp-caption alignnone">[<img class="size-large wp-image-5472" src="https://stealthpuppy.com/media/2017/06/Import-Updates-1024x423.png" alt="Import-Updates.ps1 - importing an update into MDT" width="1024" height="423" srcset="https://stealthpuppy.com/media/2017/06/Import-Updates-1024x423.png 1024w, https://stealthpuppy.com/media/2017/06/Import-Updates-150x62.png 150w, https://stealthpuppy.com/media/2017/06/Import-Updates-300x124.png 300w, https://stealthpuppy.com/media/2017/06/Import-Updates-768x317.png 768w, https://stealthpuppy.com/media/2017/06/Import-Updates.png 1127w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2017/06/Import-Updates.png)<figcaption id="caption-attachment-5472" class="wp-caption-text">Import-Updates.ps1 - importing an update into MDT*
...
<figure id="attachment_5475" aria-describedby="caption-attachment-5475" style="width: 1024px" class="wp-caption alignnone">[<img class="size-large wp-image-5475" src="https://stealthpuppy.com/media/2017/06/GetAndImport-Updates-1024x320.png" alt="Using Get-LatestUpdates.ps1 and the pipeline to pass updates to Import-Update.ps1" width="1024" height="320" srcset="https://stealthpuppy.com/media/2017/06/GetAndImport-Updates-1024x320.png 1024w, https://stealthpuppy.com/media/2017/06/GetAndImport-Updates-150x47.png 150w, https://stealthpuppy.com/media/2017/06/GetAndImport-Updates-300x94.png 300w, https://stealthpuppy.com/media/2017/06/GetAndImport-Updates-768x240.png 768w, https://stealthpuppy.com/media/2017/06/GetAndImport-Updates.png 1398w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2017/06/GetAndImport-Updates.png)<figcaption id="caption-attachment-5475" class="wp-caption-text">Using Get-LatestUpdates.ps1 and the pipeline to pass updates to Import-Update.ps1*
...
<figure id="attachment_5483" aria-describedby="caption-attachment-5483" style="width: 1024px" class="wp-caption alignnone">[<img class="size-large wp-image-5483" src="https://stealthpuppy.com/media/2017/06/MDTWorkbench-Packages-1024x456.png" alt="Latest Windows 10 Cumulative update in the Packages node" width="1024" height="456" srcset="https://stealthpuppy.com/media/2017/06/MDTWorkbench-Packages-1024x456.png 1024w, https://stealthpuppy.com/media/2017/06/MDTWorkbench-Packages-150x67.png 150w, https://stealthpuppy.com/media/2017/06/MDTWorkbench-Packages-300x134.png 300w, https://stealthpuppy.com/media/2017/06/MDTWorkbench-Packages-768x342.png 768w, https://stealthpuppy.com/media/2017/06/MDTWorkbench-Packages.png 1368w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2017/06/MDTWorkbench-Packages.png)<figcaption id="caption-attachment-5483" class="wp-caption-text">Latest Windows 10 Cumulative update in the Packages node*
