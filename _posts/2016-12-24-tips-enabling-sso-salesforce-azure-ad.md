...
![Configuring SSO for Salesforce in the Azure RM portal]({{site.baseurl}}/media/2016/12/ConfigureSalesforceSSO.png)*Configuring SSO for Salesforce in the Azure RM portal*</figure>
...
![Azure SAML certificate properties]({{site.baseurl}}/media/2016/12/AzureSAMLCertificateProperties.png)*Azure SAML certificate properties*</figure>
...
![Adding the FederationIdentity Attribute Mapping for Salesforce]({{site.baseurl}}/media/2016/12/SalesforceAttributeMapping.png)*Adding the FederationIdentity Attribute Mapping for Salesforce*</figure>
