...
While I priced up a system based on the 4770K, I ended up going with the 4820K, so that I could build a machine with 64 GB of RAM.
...
![Corsair]({{site.baseurl}}/media/2014/03/Corsair-330r.png)

I had two main requirements for a case - help the PC be as silent as possible and look unassuming (as it's not locked away but sitting next to the living room). Additionally, as I'd locked myself into an ATX board, I needed an ATX case.
...
![Corsair]({{site.baseurl}}/media/2014/03/Corsair-H55.png)
...
![Samsung]({{site.baseurl}}/media/2014/03/samsung_840_evo_ssd_0.jpg 200w, {{site.baseurl}}/media/2014/03/samsung_840_evo_ssd_0-150x78.jpg 150w" sizes="(max-width: 200px) 100vw, 200px" /> To ensure the lowest power consumption for storage devices, I've stuck with SSDs. I had a few SSDs already on hand already, but did purchase a couple more to provide more capacity.
...
![hv2-TaskManager-RAM-VanillaInstall]({{site.baseurl}}/media/2014/03/hv2-TaskManager-RAM-VanillaInstall.png)
...
![PCBuild]({{site.baseurl}}/media/2014/03/PCbuild.png)

Finally, here's a look inside the finished build:

![PC]({{site.baseurl}}/media/2014/03/InsideCustomBuild.jpg)
