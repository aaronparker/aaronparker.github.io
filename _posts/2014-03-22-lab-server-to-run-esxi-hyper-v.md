...
<img class="alignright size-full wp-image-3603" alt="ASRock-Extreme6" src="{{site.baseurl}}.com/media/2014/03/ASRock-Extreme6.jpg](http://www.asrock.com/mb/Intel/X79%20Extreme6/) with 5 x SATA 3 ports. One thing I've found out in building this PC, is that the Intel chipsets typically provide 2 x SATA3 ports only. The remaining SATA ports are provided by a second chipset (or sometimes even a third chipset). Not a problem for Windows, but not the best choice for ESXi (more on that later).

# Filling it With RAM

<img class="alignleft size-full wp-image-3604" alt="G.Skill-RipjawsX" src="{{site.baseurl}}.com/media/2014/03/G.Skill-RipjawsX.jpg" width="200" height="117" srcset="{{site.baseurl}}.com/media/2014/03/G.Skill-RipjawsX.jpg 200w, {{site.baseurl}}.com/media/2014/03/G.Skill-RipjawsX-150x87.jpg 150w" sizes="(max-width: 200px) 100vw, 200px" /> 
...
<img class="alignright size-full wp-image-3608" alt="Corsair-330r" src="{{site.baseurl}}.com/media/2014/03/Corsair-330r.png" width="200" height="264" srcset="{{site.baseurl}}.com/media/2014/03/Corsair-330r.png 200w, {{site.baseurl}}.com/media/2014/03/Corsair-330r-113x150.png 113w" sizes="(max-width: 200px) 100vw, 200px" /> I had two main requirements for a case - help the PC be as silent as possible and look unassuming (as it's not locked away but sitting next to the living room). Additionally, as I'd locked myself into an ATX board, I needed an ATX case.
...
<img class="alignleft size-full wp-image-3609" alt="Corsair-H55" src="{{site.baseurl}}.com/media/2014/03/Corsair-H55.png" width="200" height="169" srcset="{{site.baseurl}}.com/media/2014/03/Corsair-H55.png 200w, {{site.baseurl}}.com/media/2014/03/Corsair-H55-150x126.png 150w" sizes="(max-width: 200px) 100vw, 200px" /> While a water cooler probably pulls more power than a heat sink/fan combination, I went with water cooling to ensure I could move heat away from the CPU as efficiently as possible.
...
<img class="alignright size-full wp-image-3610" alt="samsung_840_evo_ssd_0" src="{{site.baseurl}}.com/media/2014/03/samsung_840_evo_ssd_0.jpg" width="200" height="104" srcset="{{site.baseurl}}.com/media/2014/03/samsung_840_evo_ssd_0.jpg 200w, {{site.baseurl}}.com/media/2014/03/samsung_840_evo_ssd_0-150x78.jpg 150w" sizes="(max-width: 200px) 100vw, 200px" /> To ensure the lowest power consumption for storage devices, I've stuck with SSDs. I had a few SSDs already on hand already, but did purchase a couple more to provide more capacity.
...
[<img class="alignnone size-full wp-image-3617" alt="hv2-TaskManager-RAM-VanillaInstall" src="{{site.baseurl}}.com/media/2014/03/hv2-TaskManager-RAM-VanillaInstall.png]({{site.baseurl}}/media/2014/03/hv2-TaskManager-RAM-VanillaInstall.png)
...
[<img class="alignnone size-full wp-image-3618" alt="Lab-ILIO-Test1" src="{{site.baseurl}}.com/media/2014/03/Lab-ILIO-Test1.png]({{site.baseurl}}/media/2014/03/Lab-ILIO-Test1.png)
...
<img class="alignnone size-full wp-image-3620" alt="128watts" src="{{site.baseurl}}.com/media/2014/03/128watts.jpg" width="656" height="412" srcset="{{site.baseurl}}.com/media/2014/03/128watts.jpg 656w, {{site.baseurl}}.com/media/2014/03/128watts-150x94.jpg 150w, {{site.baseurl}}.com/media/2014/03/128watts-300x188.jpg 300w, {{site.baseurl}}.com/media/2014/03/128watts-624x391.jpg 624w" sizes="(max-width: 656px) 100vw, 656px" /> 
...
[<img class="alignleft size-full wp-image-3613" alt="PCbuild" src="{{site.baseurl}}.com/media/2014/03/PCbuild.png]({{site.baseurl}}/media/2014/03/PCbuild.png)

Finally, here's a look inside the finished build:

[<img class="alignnone size-large wp-image-3615" alt="InsideCustomBuild" src="{{site.baseurl}}.com/media/2014/03/InsideCustomBuild-1024x768.jpg]({{site.baseurl}}/media/2014/03/InsideCustomBuild.jpg)