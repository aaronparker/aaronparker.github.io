...
For Presentation Server on Windows Server 2003 and above, this means that the SpeedFlash feature that accelerates the display of Flash is no longer version dependent. We'll be able to update Flash now without losing the acceleration support.
