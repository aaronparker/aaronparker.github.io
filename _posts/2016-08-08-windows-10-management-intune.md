...
![Intune console with MDM vs. the client]({{site.baseurl}}/media/2016/08/IntuneMDMvsAgent.png)

Intune console - note the differences between MDM (top window) and client (bottom window)
{:.figcaption}
