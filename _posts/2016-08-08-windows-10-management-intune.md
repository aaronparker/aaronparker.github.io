...
<figure id="attachment_4994" aria-describedby="caption-attachment-4994" style="width: 1024px" class="wp-caption alignnone">[<img class="wp-image-4994 size-large" src="https://stealthpuppy.com/media/2016/08/IntuneMDMvsAgent-1024x618.png" alt="Intune console with MDM vs. the client" width="1024" height="618" srcset="https://stealthpuppy.com/media/2016/08/IntuneMDMvsAgent-1024x618.png 1024w, https://stealthpuppy.com/media/2016/08/IntuneMDMvsAgent-150x91.png 150w, https://stealthpuppy.com/media/2016/08/IntuneMDMvsAgent-300x181.png 300w, https://stealthpuppy.com/media/2016/08/IntuneMDMvsAgent-768x464.png 768w, https://stealthpuppy.com/media/2016/08/IntuneMDMvsAgent.png 1554w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2016/08/IntuneMDMvsAgent.png)<figcaption id="caption-attachment-4994" class="wp-caption-text">Intune console - note the differences between MDM (top window) and client (bottom window)*
