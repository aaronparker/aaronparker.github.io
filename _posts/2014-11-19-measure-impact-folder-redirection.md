...
![]({{site.baseurl}}/media/2014/11/roaming-profile.png)*Logon impact of profile sizes with no folder redirection*
...
![]({{site.baseurl}}/media/2014/11/folder-redirection.png)*Logon impact of profile sizes with folder redirection*
...
![]({{site.baseurl}}/media/2014/11/citrix-profile-management.png)*Logon impact of profile sizes with Citrix Profile Management*
...
![]({{site.baseurl}}/media/2014/11/roaming-profile-file-server-load1.png)*Logon impact of profile sizes with roaming profiles and file server under load*
...
![Logon impact of profile sizes with folder redirection enabled and file server under load]({{site.baseurl}}/media/2014/11/folder-redirection-file-server-load.png)*Logon impact of profile sizes with folder redirection enabled and file server under load*
...
![Logon impact of profile sizes with Citrix Profile Management and file server under load]({{site.baseurl}}/media/2014/11/citrix-profile-management-file-server-load.png)*Logon impact of profile sizes with Citrix Profile Management and file server under load*
...
![ComputerDumpster" width="347" height="200" />*Long logon times makes users unhappy...*