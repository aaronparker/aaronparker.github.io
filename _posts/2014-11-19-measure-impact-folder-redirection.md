...
![]({{site.baseurl}}/media/2014/11/roaming-profile.png)*Logon impact of profile sizes with no folder redirection*</figure>
...
![]({{site.baseurl}}/media/2014/11/folder-redirection.png)*Logon impact of profile sizes with folder redirection*</figure>
...
![]({{site.baseurl}}/media/2014/11/citrix-profile-management.png)*Logon impact of profile sizes with Citrix Profile Management*</figure>
...
![]({{site.baseurl}}/media/2014/11/roaming-profile-file-server-load1.png)*Logon impact of profile sizes with roaming profiles and file server under load*</figure>
...
![Logon impact of profile sizes with folder redirection enabled and file server under load]({{site.baseurl}}/media/2014/11/folder-redirection-file-server-load.png)*Logon impact of profile sizes with folder redirection enabled and file server under load*</figure>
...
![Logon impact of profile sizes with Citrix Profile Management and file server under load]({{site.baseurl}}/media/2014/11/citrix-profile-management-file-server-load.png)*Logon impact of profile sizes with Citrix Profile Management and file server under load*</figure>
...
![ComputerDumpster" width="347" height="200" />*Long logon times makes users unhappy...*</figure>