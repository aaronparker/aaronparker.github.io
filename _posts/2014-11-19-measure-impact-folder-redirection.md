...
_This is the forth in a series of articles on folder redirection by Aaron Parker, [Helge Klein](https://helgeklein.com/) and [Shawn Bass](http://shawnbass.com/)._
  ...
  * Part two: [Visualizing the Impact of Folder Redirection – Logon and Application Launch](https://stealthpuppy.com/visualizing-impact-folder-redirection-logon/)
...
So far in this series on folder redirection, we've covered [the basics of how folder redirection works](https://helgeklein.com/blog/2014/10/folder-redirection-impacts-ux-breaks-applications), what [the impact of folder redirection is on logon and application launch](https://stealthpuppy.com/visualizing-impact-folder-redirection-logon/) and in the previous article, [Helge covered the impact on search in the Start menu](https://helgeklein.com/blog/2014/11/visualizing-impact-folder-redirection-start-menu-search/). In this article, we'll focus on actual measurements of that impact.
...
<figure id="attachment_3772" aria-describedby="caption-attachment-3772" style="width: 1702px" class="wp-caption alignnone">[<img class="wp-image-3772 size-full" src="https://stealthpuppy.com/media/2014/11/roaming-profile.png" alt="" width="1702" height="1078" srcset="https://stealthpuppy.com/media/2014/11/roaming-profile.png 1702w, https://stealthpuppy.com/media/2014/11/roaming-profile-150x95.png 150w, https://stealthpuppy.com/media/2014/11/roaming-profile-300x190.png 300w, https://stealthpuppy.com/media/2014/11/roaming-profile-1024x648.png 1024w, https://stealthpuppy.com/media/2014/11/roaming-profile-624x395.png 624w" sizes="(max-width: 1702px) 100vw, 1702px" />](https://stealthpuppy.com/media/2014/11/roaming-profile.png)<figcaption id="caption-attachment-3772" class="wp-caption-text">Logon impact of profile sizes with no folder redirection*</figure>
...
<figure id="attachment_3771" aria-describedby="caption-attachment-3771" style="width: 1700px" class="wp-caption alignnone">[<img class="wp-image-3771 size-full" src="https://stealthpuppy.com/media/2014/11/folder-redirection.png" alt="" width="1700" height="1086" srcset="https://stealthpuppy.com/media/2014/11/folder-redirection.png 1700w, https://stealthpuppy.com/media/2014/11/folder-redirection-150x95.png 150w, https://stealthpuppy.com/media/2014/11/folder-redirection-300x191.png 300w, https://stealthpuppy.com/media/2014/11/folder-redirection-1024x654.png 1024w, https://stealthpuppy.com/media/2014/11/folder-redirection-624x398.png 624w" sizes="(max-width: 1700px) 100vw, 1700px" />](https://stealthpuppy.com/media/2014/11/folder-redirection.png)<figcaption id="caption-attachment-3771" class="wp-caption-text">Logon impact of profile sizes with folder redirection*</figure>
...
<figure id="attachment_3770" aria-describedby="caption-attachment-3770" style="width: 1677px" class="wp-caption alignnone">[<img class="wp-image-3770 size-full" src="https://stealthpuppy.com/media/2014/11/citrix-profile-management.png" alt="" width="1677" height="1082" srcset="https://stealthpuppy.com/media/2014/11/citrix-profile-management.png 1677w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-150x96.png 150w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-300x193.png 300w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-1024x660.png 1024w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-624x402.png 624w" sizes="(max-width: 1677px) 100vw, 1677px" />](https://stealthpuppy.com/media/2014/11/citrix-profile-management.png)<figcaption id="caption-attachment-3770" class="wp-caption-text">Logon impact of profile sizes with Citrix Profile Management*</figure>
...
<figure id="attachment_3768" aria-describedby="caption-attachment-3768" style="width: 1703px" class="wp-caption alignnone">[<img class="wp-image-3768 size-full" src="https://stealthpuppy.com/media/2014/11/roaming-profile-file-server-load1.png" alt="" width="1703" height="1083" srcset="https://stealthpuppy.com/media/2014/11/roaming-profile-file-server-load1.png 1703w, https://stealthpuppy.com/media/2014/11/roaming-profile-file-server-load1-150x95.png 150w, https://stealthpuppy.com/media/2014/11/roaming-profile-file-server-load1-300x190.png 300w, https://stealthpuppy.com/media/2014/11/roaming-profile-file-server-load1-1024x651.png 1024w, https://stealthpuppy.com/media/2014/11/roaming-profile-file-server-load1-624x396.png 624w" sizes="(max-width: 1703px) 100vw, 1703px" />](https://stealthpuppy.com/media/2014/11/roaming-profile-file-server-load1.png)<figcaption id="caption-attachment-3768" class="wp-caption-text">Logon impact of profile sizes with roaming profiles and file server under load*</figure>
...
<figure id="attachment_3774" aria-describedby="caption-attachment-3774" style="width: 1703px" class="wp-caption alignnone">[<img class="size-full wp-image-3774" src="https://stealthpuppy.com/media/2014/11/folder-redirection-file-server-load.png" alt="Logon impact of profile sizes with folder redirection enabled and file server under load" width="1703" height="1083" srcset="https://stealthpuppy.com/media/2014/11/folder-redirection-file-server-load.png 1703w, https://stealthpuppy.com/media/2014/11/folder-redirection-file-server-load-150x95.png 150w, https://stealthpuppy.com/media/2014/11/folder-redirection-file-server-load-300x190.png 300w, https://stealthpuppy.com/media/2014/11/folder-redirection-file-server-load-1024x651.png 1024w, https://stealthpuppy.com/media/2014/11/folder-redirection-file-server-load-624x396.png 624w" sizes="(max-width: 1703px) 100vw, 1703px" />](https://stealthpuppy.com/media/2014/11/folder-redirection-file-server-load.png)<figcaption id="caption-attachment-3774" class="wp-caption-text">Logon impact of profile sizes with folder redirection enabled and file server under load*</figure>
...
<figure id="attachment_3776" aria-describedby="caption-attachment-3776" style="width: 1703px" class="wp-caption alignnone">[<img class="size-full wp-image-3776" src="https://stealthpuppy.com/media/2014/11/citrix-profile-management-file-server-load.png" alt="Logon impact of profile sizes with Citrix Profile Management and file server under load" width="1703" height="1082" srcset="https://stealthpuppy.com/media/2014/11/citrix-profile-management-file-server-load.png 1703w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-file-server-load-150x95.png 150w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-file-server-load-300x190.png 300w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-file-server-load-1024x650.png 1024w, https://stealthpuppy.com/media/2014/11/citrix-profile-management-file-server-load-624x396.png 624w" sizes="(max-width: 1703px) 100vw, 1703px" />](https://stealthpuppy.com/media/2014/11/citrix-profile-management-file-server-load.png)<figcaption id="caption-attachment-3776" class="wp-caption-text">Logon impact of profile sizes with Citrix Profile Management and file server under load*</figure>
...
<figure id="attachment_3778" aria-describedby="caption-attachment-3778" style="width: 347px" class="wp-caption alignnone"><img class="wp-image-3778 size-full" src="https://stealthpuppy.com/media/2014/11/ComputerDumpster.gif" alt="ComputerDumpster" width="347" height="200" /><figcaption id="caption-attachment-3778" class="wp-caption-text">Long logon times makes users unhappy...*</figure>