...
[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="ProcessMonitorDeletes" src="https://stealthpuppy.com/media/2011/11/ProcessMonitorDeletes_thumb.png" alt="ProcessMonitorDeletes]({{site.baseurl}}/media/2011/11/ProcessMonitorDeletes.png)
...
[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="ProcessMonitorPendingFileRenameOperations" src="https://stealthpuppy.com/media/2011/11/ProcessMonitorPendingFileRenameOperations_thumb.png" alt="ProcessMonitorPendingFileRenameOperations]({{site.baseurl}}/media/2011/11/ProcessMonitorPendingFileRenameOperations.png)
