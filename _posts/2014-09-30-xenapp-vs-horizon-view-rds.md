...
|Client-side virtualization, synchronisation or physical desktop image management|                                                                                                    |XenClient (client-side hypervisor); DesktopPlayer for Mac            |                                         |Mirage (layering and sync); VMware Player              |
...
|Flash redirection. May be client and OS dependent|*                                                                                                   |*                                                                    |~ (requires web page change)             |~ (requires web page change)                           |
|Multimedia redirection. May be client and OS dependent|*                                                                                                   |*                                                                    |?                                        |*                                                      |
