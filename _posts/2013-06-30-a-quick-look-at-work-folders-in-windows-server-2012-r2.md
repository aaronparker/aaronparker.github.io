...
[<img class="alignnone size-full wp-image-3401" alt="WorkFolders-InstallRole" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-InstallRole.png]({{site.baseurl}}/media/2013/06/WorkFolders-InstallRole.png)

Once installed, Work Folders is managed through Server Manager:

[<img class="alignnone size-full wp-image-3402" alt="WorkFolders-ServerManager" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-ServerManager.png]({{site.baseurl}}/media/2013/06/WorkFolders-ServerManager.png)
...
[<img class="alignnone size-full wp-image-3403" alt="WorkFolders-Setup1" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Setup1.png]({{site.baseurl}}/media/2013/06/WorkFolders-Setup1.png)
...
[<img class="alignnone size-full wp-image-3404" alt="WorkFolders-Setup2" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Setup2.png]({{site.baseurl}}/media/2013/06/WorkFolders-Setup2.png)
...
[<img class="alignnone size-full wp-image-3405" alt="WorkFolders-Setup3" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Setup3.png]({{site.baseurl}}/media/2013/06/WorkFolders-Setup3.png)
...
[<img class="alignnone size-full wp-image-3408" alt="WorkFolders-Setup4" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Setup4.png]({{site.baseurl}}/media/2013/06/WorkFolders-Setup4.png)
...
[<img class="alignnone size-full wp-image-3409" alt="WorkFolders-Setup5" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Setup5.png]({{site.baseurl}}/media/2013/06/WorkFolders-Setup5.png)

Once configuration is complete, there is a confirmation page:

[<img class="alignnone size-full wp-image-3410" alt="WorkFolders-Setup6" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Setup6.png]({{site.baseurl}}/media/2013/06/WorkFolders-Setup6.png)

You can then see the results as the wizard creates the Sync Share:

[<img class="alignnone size-full wp-image-3411" alt="WorkFolders-Setup7" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Setup7.png]({{site.baseurl}}/media/2013/06/WorkFolders-Setup7.png)
...
[<img class="alignnone size-full wp-image-3412" alt="WorkFolders-AaronFolder" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-AaronFolder.png]({{site.baseurl}}/media/2013/06/WorkFolders-AaronFolder.png)
...
[<img class="alignnone size-full wp-image-3413" alt="WorkFolders-AaronParkerProperties" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-AaronParkerProperties.png]({{site.baseurl}}/media/2013/06/WorkFolders-AaronParkerProperties.png)
...
[<img class="alignnone size-full wp-image-3414" alt="WorkFolders-Config1" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Config1.png]({{site.baseurl}}/media/2013/06/WorkFolders-Config1.png)

To make setup simpler, a user can use their email address, which will require some DNS configuration.

[<img class="alignnone size-full wp-image-3416" alt="WorkFolders-Config2" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Config2.png]({{site.baseurl}}/media/2013/06/WorkFolders-Config2.png)

I don't have the right DNS configuration in my test environment, so I've had to

[<img class="alignnone size-full wp-image-3417" alt="WorkFolders-Config3" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Config3.png]({{site.baseurl}}/media/2013/06/WorkFolders-Config3.png)
...
[<img class="alignnone size-full wp-image-3418" alt="WorkFolders-Config4" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Config4.png]({{site.baseurl}}/media/2013/06/WorkFolders-Config4.png)
...
[<img class="alignnone size-full wp-image-3419" alt="WorkFolders-Config5" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Config5.png]({{site.baseurl}}/media/2013/06/WorkFolders-Config5.png)
...
[<img class="alignnone size-full wp-image-3420" alt="WorkFolders-Config6" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-Config6.png]({{site.baseurl}}/media/2013/06/WorkFolders-Config6.png)

Control Panel will now display status information about Work Folders:

[<img class="alignnone size-full wp-image-3421" alt="WorkFolders-ControlPanel" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-ControlPanel.png]({{site.baseurl}}/media/2013/06/WorkFolders-ControlPanel.png)

Work Folders are now available directly from within the Computer/This PC window:

[<img class="alignnone size-full wp-image-3422" alt="WorkFolders-WindowsExplorer" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-WindowsExplorer.png]({{site.baseurl}}/media/2013/06/WorkFolders-WindowsExplorer.png)
...
[<img class="alignnone size-full wp-image-3424" alt="WorkFolders-WindowsExplorer2" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-WindowsExplorer2.png]({{site.baseurl}}/media/2013/06/WorkFolders-WindowsExplorer2.png)

Drilling down a bit further, I can see the data stored in my Work Folders and access it just like any other local folder.

[<img class="alignnone size-full wp-image-3425" alt="WorkFolders-WindowsExplorer3" src="{{site.baseurl}}.com/media/2013/06/WorkFolders-WindowsExplorer3.png]({{site.baseurl}}/media/2013/06/WorkFolders-WindowsExplorer3.png)
