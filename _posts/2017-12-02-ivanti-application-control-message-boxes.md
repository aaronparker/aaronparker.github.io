...
![Ivanti Application Control default access denied dialog box]({{site.baseurl}}/media/2017/11/DefaultDenied.png)
...
![Ivanti Application Control default self-elevation message box]({{site.baseurl}}/media/2017/11/DefaultElevate.png)
...
![Windows User Account Control message box]({{site.baseurl}}/media/2017/11/WindowsUACLight.png)
...
![Ivanti Application Control message settings]({{site.baseurl}}/media/2017/11/MessageSettings.png)
...
![Ivanti Application Control access denied message box with improved styling]({{site.baseurl}}/media/2017/11/Denied.png)
...
![Ivanti Application Control self-elevation message box with improved styling]({{site.baseurl}}/media/2017/11/Elevate.png)
...
![Ivanti Application Control system controls message box with improved styling]({{site.baseurl}}/media/2017/11/Uninstall.png)
...
![Ivanti Application Control Access Denied Dialog at 200% scaling]({{site.baseurl}}/media/2017/12/ivanti-highdpi.png)
...
![Setting Application Control High DPI Scaling Compatibility]({{site.baseurl}}/media/2017/12/ivanti-agent-compatibility.png)
