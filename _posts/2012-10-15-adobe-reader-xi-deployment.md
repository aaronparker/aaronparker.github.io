...
tags:
  - Adobe Reader
---
[<img class="alignright size-full wp-image-2848" style="margin-left: 5px; margin-right: 5px;" title="ReaderXI-Installer" src="{{site.baseurl}}.com/media/2012/10/ReaderXI-Installer.png" alt="](http://get.adobe.com/reader/) is now available and along with this release comes some interesting tools for deployment:
...
<img title="ReaderXI-GroupPolicy" src="{{site.baseurl}}.com/media/2012/10/ReaderXI-GroupPolicy.png" alt="" width="440" height="165" /> 
