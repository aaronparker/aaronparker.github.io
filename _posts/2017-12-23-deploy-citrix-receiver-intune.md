...
![Adding the Install-CitrixReceiver.ps1 script to Intune]({{site.baseurl}}/media/2017/12/Script-Adding.png)
...
![Install-CitrixReceiver.ps1 along side other PowerShell scripts]({{site.baseurl}}/media/2017/12/All-Scripts.png)
...
![Citrix Receiver deployment overview]({{site.baseurl}}/media/2017/12/Script-Overview.png)
