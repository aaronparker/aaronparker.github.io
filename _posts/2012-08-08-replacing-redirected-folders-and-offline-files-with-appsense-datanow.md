...
[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="DataNow diagram" src="{{site.baseurl}}/media/2012/08/diagram_thumb.png" alt="DataNow diagram]({{site.baseurl}}/media/2012/08/diagram.png)
...
[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="DataNow client folder" src="{{site.baseurl}}/media/2012/08/folder1_thumb.png" alt="DataNow client folder]({{site.baseurl}}/media/2012/08/folder1.png)

Whilst the DataNow folder contains each of the redirected user folders:

[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="DataNow client folder contents" src="{{site.baseurl}}/media/2012/08/folder2_thumb.png" alt="DataNow client folder contents]({{site.baseurl}}/media/2012/08/folder2.png)
...
[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="Home folder" src="{{site.baseurl}}/media/2012/08/folder3_thumb.png" alt="Home folder]({{site.baseurl}}/media/2012/08/folder3.png)
