...
<p style="text-align: center;">
  <img class="size-full wp-image-1218  aligncenter" title="AudioDrivers" src="{{site.baseurl}}.com/media/2009/10/AudioDrivers.png" alt="AudioDrivers" width="380" height="124" srcset="{{site.baseurl}}.com/media/2009/10/AudioDrivers.png 380w, {{site.baseurl}}.com/media/2009/10/AudioDrivers-150x48.png 150w, {{site.baseurl}}.com/media/2009/10/AudioDrivers-300x97.png 300w" sizes="(max-width: 380px) 100vw, 380px" />
</p>
