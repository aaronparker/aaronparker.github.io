...
![Visual Studio Code on OS X](https://stealthpuppy.com/media/2016/03/Visual-Studio-Code-OSX.png)*Visual Studio Code on OS X*

And here's the same view on Windows:

![Visual Studio Code on Windows 10](https://stealthpuppy.com/media/2016/03/Visual-Studio-Code-Windows2.png)*Visual Studio Code on Windows 10*
...
![Installing PowerShell language syntax support on OS X](https://stealthpuppy.com/media/2016/03/Visual-Studio-Code-install-powershell.png)*Installing PowerShell language syntax support on OS X*

Updating extensions is handled in the same manner:

![Updating extensions in Visual Studio Code on OS X](https://stealthpuppy.com/media/2016/03/Visual-Studio-Code-update-extensions.png)*Updating extensions in Visual Studio Code on OS X*
...
![Creating a repository in GitHub](https://stealthpuppy.com/media/2016/03/GitHub-Create-Respository.png)*Creating a repository in GitHub*
...
![GitHub Desktop on OS X](https://stealthpuppy.com/media/2016/03/GitHub-Desktop-OSX.png)*GitHub Desktop on OS X*

For a Windows application,

![GitHub Desktop on Windows 10](https://stealthpuppy.com/media/2016/03/GitHub-Desktop-Windows.png)*GitHub Desktop on Windows 10*
...
![Cloning a repository in GitHub Desktop](https://stealthpuppy.com/media/2016/03/GitHub-Desktop-Cloning-Repository.png)*Cloning a repository in GitHub Desktop*
...
![Git integration into Visual Studio Code](https://stealthpuppy.com/media/2016/03/Visual-Studio-Code-git.png)*Git integration into Visual Studio Code*
