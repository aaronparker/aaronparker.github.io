...
![What is used to deliver a standardised image to VMs or end-points.]({{site.baseurl}}/media/2015/11/WhatIsUsedToDeliverImage.png)

What is used to deliver a standardised image to VMs or end-points
{:.figcaption}
