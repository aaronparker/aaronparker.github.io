...
![Linking an Azure subscription to a new OMS workspace]({{site.baseurl}}/media/2016/12/OMS-Azure-Link-subscription.png)*Linking an Azure subscription to a new OMS workspace*
...
![Selecting a data plan for the OMS workspace]({{site.baseurl}}/media/2016/12/oms-workspace-dataplan.png)*Selecting a data plan for the OMS workspace*
...
![OMS Solutions Gallery]({{site.baseurl}}/media/2016/12/oms-marketplace.png)*OMS Solutions Gallery*
...
![OMS Installed Solutions]({{site.baseurl}}/media/2016/12/oms-solutions.png)*OMS Installed Solutions*
...
![Update Management overview in OMS]({{site.baseurl}}/media/2016/12/oms-update-management.png)*Update Management overview in OMS*

So too can I see the antimalware assessment across managed PCs.

![Antimalware Assessment in OMS]({{site.baseurl}}/media/2016/12/oms-antimalware-assessment.png)*Antimalware Assessment in OMS*
...
![Extracting the OMS agent to access the MSI]({{site.baseurl}}/media/2016/12/oms-extract-agent.png)*Extracting the OMS agent to access the MSI*
...
![Adding MOMAgent.MSI via the Intune Software Publisher]({{site.baseurl}}/media/2016/12/OMS-AddApp01.png)*Adding MOMAgent.MSI via the Intune Software Publisher*
...
![Setting command line arguments on the application properties]({{site.baseurl}}/media/2016/12/OMS-AddApp06.png)*Setting command line arguments on the application properties*
