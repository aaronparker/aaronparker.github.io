...
[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="SyncConflictHandling" src="https://stealthpuppy.com/media/2010/08/SyncConflictHandling_thumb1.png" border="0" alt="SyncConflictHandling" width="660" height="173" />]({{site.baseurl}}/media/2010/08/SyncConflictHandling1.png)
...
[<img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border-width: 0px;" title="GPPrefReg" src="https://stealthpuppy.com/media/2010/08/GPPrefReg_thumb.png" border="0" alt="GPPrefReg" width="404" height="448" />]({{site.baseurl}}/media/2010/08/GPPrefReg.png)
