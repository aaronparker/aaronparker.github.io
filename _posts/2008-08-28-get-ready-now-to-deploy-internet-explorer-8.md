...
![]({{site.baseurl}}/media/2008/08/compatibilityviewsettings.png)

* It's also really simple for users to enable Compatibility View with the Compatibility View button
  
![]({{site.baseurl}}/media/2008/08/compatibilityviewbutton.png)
