...
[<img class="wp-image-5187 size-large" src="https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs-1024x482.png" alt="Virtual Machines folder for the MCS Master Image on Hyper-V]({{site.baseurl}}/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs.png)*Virtual Machines folder for the MCS Master Image on Hyper-V* 
...
[<img class="wp-image-5188 size-large" src="https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots-1024x482.png" alt="Snapshots folder for the MCS Master Image on Hyper-V]({{site.baseurl}}/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots.png)*Snapshots folder for the MCS Master Image on Hyper-V* 
...
[<img class="wp-image-5193 size-large" src="https://stealthpuppy.com/media/2016/10/MCS-Master-Image-3-Snapshots-1024x467.png" alt="Master Image and snapshots after 3 updates]({{site.baseurl}}/media/2016/10/MCS-Master-Image-3-Snapshots.png)*Master Image and snapshots after 3 updates* 
...
[<img class="wp-image-5200 size-full" src="https://stealthpuppy.com/media/2016/10/01_CreatingMachineCatalog-Default.png" alt="Default virtual machine options for XenApp Machine Catalogs]({{site.baseurl}}/media/2016/10/01_CreatingMachineCatalog-Default.png)*Default virtual machine options for XenApp Machine Catalogs* 
...
[<img class="size-full wp-image-5233" src="https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-RDS.png" alt="Disk cache size warning for Server OS VMs]({{site.baseurl}}/media/2016/10/Virtual-Machine-Options-RDS.png)*Disk cache size warning for Server OS VMs* 
...
[<img class="size-full wp-image-5234" src="https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-VDI.png" alt="Disk cache size warning for Desktop OS VMs]({{site.baseurl}}/media/2016/10/Virtual-Machine-Options-VDI.png)*Disk cache size warning for Desktop OS VMs* 
...
[<img class="wp-image-5196 size-large" src="https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog-1024x450.png" alt="Machine Creation Services preparing the catalog via a temporary VM]({{site.baseurl}}/media/2016/10/04_Preparing-Catalog.png)*Machine Creation Services preparing the catalogue via a temporary VM* 
...
[<img class="wp-image-5254 size-large" src="https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk-1024x411.png" alt="MCS Machine Catalog base image for Windows Server 2016]({{site.baseurl}}/media/2016/10/vSphere-WindowsServer2016-baseDisk.png)*MCS Machine Catalog base image for Windows Server 2016* 
...
[<img class="size-large wp-image-5198" src="https://stealthpuppy.com/media/2016/10/MCS-base-disk-updates-1024x476.png" alt="MCS machine catalog base image after 3 updates]({{site.baseurl}}/media/2016/10/MCS-base-disk-updates.png)*MCS Machine Catalog base image after 3 updates* 
...
[<img class="size-large wp-image-5199" src="https://stealthpuppy.com/media/2016/10/MCS-base-disk-updates-2-images-1024x453.png" alt="MCS machine catalog base image after updates applied]({{site.baseurl}}/media/2016/10/MCS-base-disk-updates-2-images.png)*MCS Machine Catalog base image after updates applied* 
...
[<img class="size-large wp-image-5205" src="https://stealthpuppy.com/media/2016/10/12_MCS-VM-User-logon-Tempstorage-growing-1024x450.png" alt="MCS VM with temporary storage growth]({{site.baseurl}}/media/2016/10/12_MCS-VM-User-logon-Tempstorage-growing.png)*MCS VM with temporary storage growth* 
...
[<img class="size-large wp-image-5216" src="https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All-1024x552.png" alt="MCS VM storage viewed in Virtual Machine Manager]({{site.baseurl}}/media/2016/10/SCVMM-StorageView-All.png)*MCS VM storage viewed in Virtual Machine Manager* 
...
[<img class="size-full wp-image-5223" src="https://stealthpuppy.com/media/2016/10/MCS-delta-disk-creation.png" alt="MCS Virtual Machines without storage optimisation (as per XenApp/XenDesktop 7.8 and below)]({{site.baseurl}}/media/2016/10/MCS-delta-disk-creation.png)*MCS Virtual Machines without storage optimisation (as per XenApp/XenDesktop 7.8 and below)* 
...
[<img class="size-full wp-image-5224" src="https://stealthpuppy.com/media/2016/10/MCS-delta-disk-boot.png" alt="MCS Delta Clones after boot showing growth in the differencing disk]({{site.baseurl}}/media/2016/10/MCS-delta-disk-boot.png)*MCS Delta Clones after boot showing growth in the differencing disk* 
...
[<img class="size-large wp-image-5226" src="https://stealthpuppy.com/media/2016/10/MCS-Full-Clone-1024x472.png" alt="Disk configuration for MCS Full Clones]({{site.baseurl}}/media/2016/10/MCS-Full-Clone.png)*Disk configuration for MCS Full Clones* 
