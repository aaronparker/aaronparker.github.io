...
author: Aaron Parker
layout: post
guid: https://stealthpuppy.com/?p=5250
permalink: /?p=5250
layers:
  - 'a:1:{s:9:"video-url";s:0:"";}'
image: /media/2016/10/10747531785_390955e49b_o.jpg
categories:
  - Citrix
tags:
...
In the previous article, I showed how to approach [storage capacity sizing with XenDesktop on Hyper-V](https://stealthpuppy.com/mcs-capacity-sizing-hyper-v/). In this article, I'll take the same approach to sizing on vSphere.

To [understand sizing Machine Creation Services](https://stealthpuppy.com/machine-creation-services-storage-capacity/) on vSphere, let's first cover how XenDesktop creates virtual machines across the various deployment choices available. XenDesktop 7.9 and 7.11 have introduced new features to MCS that will require additional consideration for storage requirements over previous versions.
...
[<img class="wp-image-5187 size-large" src="https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs-1024x482.png" alt="Virtual Machines folder for the MCS Master Image on Hyper-V" width="1024" height="482" srcset="https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs-1024x482.png 1024w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs-150x71.png 150w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs-300x141.png 300w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs-768x361.png 768w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs.png 1061w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-VMs.png)<figcaption id="caption-attachment-5187" class="wp-caption-text">Virtual Machines folder for the MCS Master Image on Hyper-V* 
...
[<img class="wp-image-5188 size-large" src="https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots-1024x482.png" alt="Snapshots folder for the MCS Master Image on Hyper-V" width="1024" height="482" srcset="https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots-1024x482.png 1024w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots-150x71.png 150w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots-300x141.png 300w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots-768x361.png 768w, https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots.png 1061w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2016/10/MCS-HyperV-TopLevel-Datastore-MasterImage-Snapshots.png)<figcaption id="caption-attachment-5188" class="wp-caption-text">Snapshots folder for the MCS Master Image on Hyper-V* 
...
[<img class="wp-image-5200 size-full" src="https://stealthpuppy.com/media/2016/10/01_CreatingMachineCatalog-Default.png" alt="Default virtual machine options for XenApp Machine Catalogs" width="806" height="605" srcset="https://stealthpuppy.com/media/2016/10/01_CreatingMachineCatalog-Default.png 806w, https://stealthpuppy.com/media/2016/10/01_CreatingMachineCatalog-Default-150x113.png 150w, https://stealthpuppy.com/media/2016/10/01_CreatingMachineCatalog-Default-300x225.png 300w, https://stealthpuppy.com/media/2016/10/01_CreatingMachineCatalog-Default-768x576.png 768w" sizes="(max-width: 806px) 100vw, 806px" />](https://stealthpuppy.com/media/2016/10/01_CreatingMachineCatalog-Default.png)<figcaption id="caption-attachment-5200" class="wp-caption-text">Default virtual machine options for XenApp Machine Catalogs* 
...
[<img class="size-full wp-image-5233" src="https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-RDS.png" alt="Disk cache size warning for Server OS VMs" width="806" height="605" srcset="https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-RDS.png 806w, https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-RDS-150x113.png 150w, https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-RDS-300x225.png 300w, https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-RDS-768x576.png 768w" sizes="(max-width: 806px) 100vw, 806px" />](https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-RDS.png)<figcaption id="caption-attachment-5233" class="wp-caption-text">Disk cache size warning for Server OS VMs* 
...
[<img class="size-full wp-image-5234" src="https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-VDI.png" alt="Disk cache size warning for Desktop OS VMs" width="806" height="605" srcset="https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-VDI.png 806w, https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-VDI-150x113.png 150w, https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-VDI-300x225.png 300w, https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-VDI-768x576.png 768w" sizes="(max-width: 806px) 100vw, 806px" />](https://stealthpuppy.com/media/2016/10/Virtual-Machine-Options-VDI.png)<figcaption id="caption-attachment-5234" class="wp-caption-text">Disk cache size warning for Desktop OS VMs* 
...
[<img class="wp-image-5196 size-large" src="https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog-1024x450.png" alt="Machine Creation Services preparing the catalog via a temporary VM" width="1024" height="450" srcset="https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog-1024x450.png 1024w, https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog-150x66.png 150w, https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog-300x132.png 300w, https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog-768x337.png 768w, https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog.png 1125w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2016/10/04_Preparing-Catalog.png)<figcaption id="caption-attachment-5196" class="wp-caption-text">Machine Creation Services preparing the catalogue via a temporary VM* 
...
[<img class="wp-image-5254 size-large" src="https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk-1024x411.png" alt="MCS Machine Catalog base image for Windows Server 2016" width="1024" height="411" srcset="https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk-1024x411.png 1024w, https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk-150x60.png 150w, https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk-300x120.png 300w, https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk-768x308.png 768w, https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk.png 1103w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2016/10/vSphere-WindowsServer2016-baseDisk.png)<figcaption id="caption-attachment-5254" class="wp-caption-text">MCS Machine Catalog base image for Windows Server 2016* 
...
[<img class="size-large wp-image-5216" src="https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All-1024x552.png" alt="MCS VM storage viewed in Virtual Machine Manager" width="1024" height="552" srcset="https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All-1024x552.png 1024w, https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All-150x81.png 150w, https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All-300x162.png 300w, https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All-768x414.png 768w, https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All.png 1234w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2016/10/SCVMM-StorageView-All.png)<figcaption id="caption-attachment-5216" class="wp-caption-text">MCS VM storage viewed in Virtual Machine Manager* 
...
[<img class="size-full wp-image-5223" src="https://stealthpuppy.com/media/2016/10/MCS-delta-disk-creation.png" alt="MCS Virtual Machines without storage optimisation (as per XenApp/XenDesktop 7.8 and below)" width="1018" height="494" srcset="https://stealthpuppy.com/media/2016/10/MCS-delta-disk-creation.png 1018w, https://stealthpuppy.com/media/2016/10/MCS-delta-disk-creation-150x73.png 150w, https://stealthpuppy.com/media/2016/10/MCS-delta-disk-creation-300x146.png 300w, https://stealthpuppy.com/media/2016/10/MCS-delta-disk-creation-768x373.png 768w" sizes="(max-width: 1018px) 100vw, 1018px" />](https://stealthpuppy.com/media/2016/10/MCS-delta-disk-creation.png)<figcaption id="caption-attachment-5223" class="wp-caption-text">MCS Virtual Machines without storage optimisation (as per XenApp/XenDesktop 7.8 and below)* 
...
[<img class="size-large wp-image-5226" src="https://stealthpuppy.com/media/2016/10/MCS-Full-Clone-1024x472.png" alt="Disk configuration for MCS Full Clones" width="1024" height="472" srcset="https://stealthpuppy.com/media/2016/10/MCS-Full-Clone-1024x472.png 1024w, https://stealthpuppy.com/media/2016/10/MCS-Full-Clone-150x69.png 150w, https://stealthpuppy.com/media/2016/10/MCS-Full-Clone-300x138.png 300w, https://stealthpuppy.com/media/2016/10/MCS-Full-Clone-768x354.png 768w, https://stealthpuppy.com/media/2016/10/MCS-Full-Clone.png 1081w" sizes="(max-width: 1024px) 100vw, 1024px" />](https://stealthpuppy.com/media/2016/10/MCS-Full-Clone.png)<figcaption id="caption-attachment-5226" class="wp-caption-text">Disk configuration for MCS Full Clones* 
